...
package com.hubspot.mesos.rx.java.example.framework.sleepy;
...
import com.hubspot.mesos.rx.java.protobuf.ProtoUtils;
import com.hubspot.mesos.rx.java.protobuf.ProtobufMesosClientBuilder;
import com.hubspot.mesos.rx.java.protobuf.SchedulerCalls;
...
import static com.hubspot.mesos.rx.java.SinkOperations.sink;
import static com.hubspot.mesos.rx.java.protobuf.SchedulerCalls.decline;
import static com.hubspot.mesos.rx.java.protobuf.SchedulerCalls.subscribe;
import static com.hubspot.mesos.rx.java.util.UserAgentEntries.userAgentEntryForMavenArtifact;
...
public final class Sleepy {
    ...
    /**
     * <pre>{@code
     * Usage: java -cp <application-jar> com.hubspot.mesos.rx.java.example.framework.sleepy.Sleepy <mesos-uri> <cpus-per-task> <mesos-resource-role>
    ...
    static void _main(final String fwId, final String... args) throws Throwable {
        ...
        final MesosClientBuilder<Call, Event> clientBuilder = ProtobufMesosClientBuilder.schedulerUsingProtos()
            .mesosUri(mesosUri)
            .applicationUserAgentEntry(userAgentEntryForMavenArtifact("com.hubspot.mesos.rx.java.example", "mesos-rxjava-example-framework"));
